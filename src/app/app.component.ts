...
import { MediumEditorComponent } from './exports/medium-editor/medium-editor.component';
  ...
  private setupMenus() {
    ...
    this.menus = {
      ...
      menus: [
        ...
        {
          text: 'API Docs',
          url: '/rebirth-medium-editor//compodocs/overview.html',
          target: '_blank',
          icon: 'glyphicon glyphicon-heart'
        },
        {
          text: '@Github',
          url: 'https://github.com/greengerong/rebirth-medium-editor',
          target: '_blank',
